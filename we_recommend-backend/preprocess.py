...
def Json2Dataframe(reviewJson):
    ...
    detail=reviewJson["detail"]
    usrID=reviewJson["username"]
    profile=reviewJson["profile"]
    ...
    return asin,usrID,detail,profile,reviewData

if __name__=="__main__":
    reviewJson=LoadJson("/Users/uu/Documents/product-review-identification-and-generation-platform-main 2/pipeline&elasticsearch/input_data/final.json")
